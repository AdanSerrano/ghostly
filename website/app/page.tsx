        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {([
              ...
              { icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0021 18V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25z" /></svg>, title: 'CLI Tool', desc: 'ghostly init, add loading, doctor. Auto-generate loading.tsx.' },
