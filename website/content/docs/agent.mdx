...
The `@ghostly/mcp` package gives AI assistants direct access to Ghostly's API, components, installation instructions, and examples — no hallucination, always up-to-date.
